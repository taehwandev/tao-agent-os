...
RUNTIME_START_BRIDGE_PHRASE = (
    ...
    "and ambiguity. Compute that fingerprint with agent-hook.py fingerprint --request \"<user "
    "request>\"; it also prints an envelope skeleton and stays callable before any start. When the "

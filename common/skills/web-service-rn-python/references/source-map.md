...
- Vercel Labs `vercel-labs/agent-skills`, `skills/react-best-practices/SKILL.md`,
...
- Callstack Incubator `callstackincubator/agent-skills`,
  `skills/react-native-best-practices/SKILL.md`, for React Native performance,
  memory, bridge, list, animation, and bundle guidance.
- Vercel-flavored React Native wrapper in Callstack Incubator
  `plugins/vendored/.agents/skills/vercel-react-native-skills/SKILL.md`, for
  React Native and Expo branch routing.
...
- FastAPI official docs via Context7 library `/websites/fastapi_tiangolo` for
  ...
  testing behavior.
- `nealepetrillo/claude-skills-fastapi`, `.claude/skills/fastapi/SKILL.md`, for
  a FastAPI skill map sourced from the official docs.

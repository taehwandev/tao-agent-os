...
- Figma extraction, handoff bundles, and design-to-code implementation: `common/skills/figma-handoff/SKILL.md` (platform mapping: `platforms/android/skills/figma-to-compose/SKILL.md`, `platforms/ios/skills/figma-to-swiftui/SKILL.md`, `platforms/web/skills/figma-to-web/SKILL.md`)
